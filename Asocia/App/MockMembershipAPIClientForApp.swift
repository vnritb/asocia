...
/// Simula un backend funcional completo para desarrollo de UI sin servidor.
///
/// Este actor proporciona una instancia compartida (`.shared`) que se usa
/// como valor por defecto en `AsociaApp` cuando no hay backend disponible.
actor MockMembershipAPIClient: MembershipAPIClient {
    ...
    /// Constructor privado para forzar el uso de .shared
    private init() {}
